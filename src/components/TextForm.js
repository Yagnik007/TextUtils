...
export default function TextForm(props) {
  ...
  return (
    ...
    <div className="container my-3" style = {{color: props.mode === 'dark'? 'white' :'black'}}>
        ...
        <div className="btn btn-danger my-2 mx-2" onClick={handleUpClick}>UpperCase</div>
        <div className="btn btn-danger my-2 mx-2" onClick={handleLoClick}>LowerCase</div>
        <div className="btn btn-danger my-2 mx-2" onClick={copyToClipboard}>Copy</div>
